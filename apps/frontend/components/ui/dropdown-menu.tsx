		...
		<DropdownMenuPortal>
			<DropdownMenuPrimitive.Content
				...
				className={cnMerge(
					...
					border bg-shadcn-popover
					p-1 text-shadcn-popover-foreground shadow-md
					data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 data-[state=closed]:animate-out
	...
	return (
		<DropdownMenuPrimitive.Item
			...
			className={cnMerge(
				...
				px-2
				py-1.5
				text-sm outline-hidden select-none focus:bg-shadcn-accent
				focus:text-shadcn-accent-foreground data-[disabled]:pointer-events-none data-[disabled]:opacity-50 data-[variant=destructive]:text-shadcn-destructive data-[variant=destructive]:focus:bg-shadcn-destructive/10 data-[variant=destructive]:focus:text-shadcn-destructive dark:data-[variant=destructive]:focus:bg-shadcn-destructive/20
				[&_svg]:pointer-events-none [&_svg]:shrink-0
				[&_svg:not([class*='size-'])]:size-4 [&_svg:not([class*='text-'])]:text-shadcn-muted-foreground data-[variant=destructive]:*:[svg]:text-shadcn-destructive!`,
				inset && "pl-8",
				className
			)}
			{...restOfProps}
	...
	return (
		<DropdownMenuPrimitive.CheckboxItem
			...
			className={cnMerge(
				...
				rounded-sm py-1.5 pr-2 pl-8 text-sm outline-hidden select-none focus:bg-shadcn-accent focus:text-shadcn-accent-foreground
	...
	return (
		<DropdownMenuPrimitive.SubTrigger
			...
			className={cnMerge(
				...
				text-sm outline-hidden select-none focus:bg-shadcn-accent focus:text-shadcn-accent-foreground data-[state=open]:bg-shadcn-accent data-[state=open]:text-shadcn-accent-foreground`,
				inset && "pl-8",
				className
			)}
			{...restOfProps}
	...
	return (
		<DropdownMenuPrimitive.SubContent
			...
			className={cnMerge(
				...
				rounded-md border
				bg-shadcn-popover p-1
				text-shadcn-popover-foreground shadow-lg data-[side=bottom]:slide-in-from-top-2
				data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 data-[state=closed]:animate-out data-[state=closed]:fade-out-0
