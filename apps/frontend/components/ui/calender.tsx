...
export function Calendar(
	...
	return (
		<DayPicker
			...
			className={cnMerge(
				`group/calendar bg-shadcn-background p-3
				[--cell-size:--spacing(8)] in-data-[slot=card-content]:bg-transparent in-data-[slot=popover-content]:bg-transparent`,
				// prettier-ignore
			...
			classNames={{
				...
				dropdown_root: cnMerge(
					`relative rounded-md border border-shadcn-input
					shadow-xs has-focus:border-shadcn-ring has-focus:ring-[3px] has-focus:ring-shadcn-ring/50`,
	...
	return (
		<button
			...
			className={cnMerge(
				...
				group-data-[focused=true]/day:z-10 group-data-[focused=true]/day:ring-[3px] group-data-[focused=true]/day:ring-shadcn-ring/30 data-[range-end=true]:rounded-md data-[range-end=true]:rounded-r-md data-[range-end=true]:bg-shadcn-primary data-[range-end=true]:text-shadcn-primary-foreground
				data-[range-middle=true]:rounded-none data-[range-middle=true]:bg-shadcn-accent data-[range-middle=true]:text-shadcn-primary-foreground data-[range-start=true]:rounded-md
				data-[range-start=true]:rounded-l-md data-[range-start=true]:bg-shadcn-primary
				data-[range-start=true]:text-shadcn-primary-foreground data-[selected-single=true]:bg-shadcn-primary
				data-[selected-single=true]:text-shadcn-primary-foreground dark:hover:text-shadcn-primary-foreground [&>span]:text-xs
				[&>span]:opacity-70`,
				defaultClassNames.day,
