...
export const shadcnButtonVariants = tv({
	...
	gap-2 rounded-md text-sm font-medium whitespace-nowrap ring-offset-shadcn-background transition-colors focus-visible:ring-2
	focus-visible:ring-shadcn-ring focus-visible:ring-offset-2 focus-visible:outline-hidden disabled:pointer-events-none
	...
	variants: {
		...
		variant: {
			...
			outline: `border border-shadcn-input bg-shadcn-background
