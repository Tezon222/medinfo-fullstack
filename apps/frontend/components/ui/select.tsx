	...
	return (
		<SelectPrimitive.Trigger
			...
			className={cnMerge(
				...
				whitespace-nowrap shadow-xs transition-[color,box-shadow] outline-none focus-visible:border-shadcn-ring focus-visible:ring-[3px] focus-visible:ring-shadcn-ring/50 disabled:cursor-not-allowed disabled:opacity-50
				aria-invalid:border-shadcn-destructive aria-invalid:ring-shadcn-destructive/20 data-[placeholder]:text-shadcn-muted-foreground *:data-[slot=select-value]:line-clamp-1
				*:data-[slot=select-value]:flex *:data-[slot=select-value]:items-center *:data-[slot=select-value]:gap-2
				dark:aria-invalid:ring-shadcn-destructive/40 [&_svg]:pointer-events-none
				[&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4 [&_svg:not([class*='text-'])]:text-shadcn-muted-foreground`,
				size === "sm" && "h-8",
				size === "default" && "h-9",
				className,
				classNames?.base
	...
	return (
		<SelectPrimitive.Item
			...
			className={cnMerge(
				...
				select-none focus:bg-shadcn-accent focus:text-shadcn-accent-foreground data-[disabled]:pointer-events-none data-[disabled]:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4
				[&_svg:not([class*='text-'])]:text-shadcn-muted-foreground *:[span]:last:flex *:[span]:last:items-center
				*:[span]:last:gap-2`,
				className
			)}
			{...restOfProps}
