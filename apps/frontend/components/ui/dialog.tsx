		...
		<DialogPortal>
			...
			<DialogPrimitive.Content
				...
				className={cnMerge(
					...
					z-50 grid w-full
					max-w-[calc(100%-2rem)] translate-[-50%] gap-4 rounded-lg border bg-shadcn-background
					p-6 shadow-lg duration-200 data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=closed]:zoom-out-95 data-[state=open]:animate-in data-[state=open]:fade-in-0 data-[state=open]:zoom-in-95
					sm:max-w-lg`,
					className
				)}
				{...restOfProps}
				...
				{withCloseBtn && (
					<DialogClose
						className="absolute top-4 right-4
							...
							ring-offset-shadcn-background transition-opacity hover:opacity-100 focus:ring-2 focus:ring-shadcn-ring
							focus:ring-offset-2 focus:outline-hidden disabled:pointer-events-none data-[state=open]:bg-shadcn-accent
