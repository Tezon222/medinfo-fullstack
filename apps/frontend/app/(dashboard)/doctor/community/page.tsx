		...
		<div className="px-[28px] py-[56px] lg:p-[40px]">
			<div className="gap-[32px] rounded-[16px] bg-white p-[16px] shadow-md lg:p-[32px]">
				<div className="space-y-[12px] lg:w-full lg:max-w-[661.8px]">
					<div
						className="border-medinfo-light-1 flex cursor-pointer flex-col gap-[16px] rounded-[8px]
							border border-solid p-[16px] lg:flex-row lg:justify-between"
					...
					>
						<div className="flex gap-[12px]">
							...
							<div>
								...
								<p className="text-medinfo-dark-3 font-normal">
						...
						<div className="hidden flex-col space-y-[5.5px] lg:flex">
							<div className="flex items-center justify-end gap-[4px]">
								<ViewIcon />
								<p className="text-medinfo-dark-3 text-[14px] font-normal">13 views</p>
							</div>
							...
							<div className="flex items-center gap-[4px]">
								<CommentIcon />
								<p className="text-medinfo-dark-3 text-[14px] font-normal">32 comments</p>
							</div>
						</div>
					...
					<p
						className="text-medinfo-primary-main mt-[32px] text-right text-[16px] font-medium
