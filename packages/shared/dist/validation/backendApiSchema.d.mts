...
declare const BaseErrorResponseSchema: z.ZodObject<
	{
		errors: z.ZodUnion<
			[z.ZodRecord<z.ZodString, z.ZodUnion<[z.ZodString, z.ZodArray<z.ZodString>]>>, z.ZodUndefined]
		>;
		message: z.ZodString;
	...
	z.core.$strip
>;
type BaseApiSuccessResponse<TData = z.infer<typeof BaseSuccessResponseSchema.shape.data>> = Omit<
	z.infer<typeof BaseSuccessResponseSchema>,
	"data"
> & {
	data: TData;
};
type BaseApiErrorResponse<TErrors = z.infer<typeof BaseErrorResponseSchema>["errors"]> = Omit<
		...
		"@get/health-tips/all": {
			...
			query: z.ZodOptional<
				z.ZodObject<
					{
						limit: z.ZodOptional<
							z.ZodPipe<z.ZodTransform<string, any>, z.ZodTransform<number, string>>
						>;
					},
					z.core.$strip
				>
				...
				z.ZodObject<
					{
						...
						page: z.ZodOptional<
							z.ZodPipe<z.ZodTransform<string, any>, z.ZodTransform<number, string>>
						>;
						random: z.ZodOptional<
							z.ZodPipe<z.ZodTransform<string, any>, z.ZodTransform<boolean | "unknown", string>>
						>;
					},
					z.core.$strip
				>
			...
			errorData: z.ZodObject<
				{
					errors: z.ZodUnion<
						[
							z.ZodRecord<z.ZodString, z.ZodUnion<[z.ZodString, z.ZodArray<z.ZodString>]>>,
							z.ZodUndefined,
						]
					>;
					message: z.ZodString;
